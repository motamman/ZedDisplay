...
- [ ] Finish refactoring for single source of truth for base URL (`httpBaseUrl` on SignalKService) — migrate remaining scattered `$protocol://$_serverUrl` constructions in SignalKService internal REST calls
